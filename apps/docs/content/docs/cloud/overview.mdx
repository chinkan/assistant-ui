...
Assistant Cloud is a hosted service that provides thread management and message history for AI chat applications. It automatically persists threads, supports human-in-the-loop workflows, and integrates with common auth providers to seamlessly allow users to resume conversations at any point. Works with any React UI — with or without assistant-ui components.
...
- [AI SDK](/docs/cloud/ai-sdk) — two hooks, bring your own UI
- [AI SDK + assistant-ui](/docs/cloud/ai-sdk-assistant-ui) — full integration with pre-built components
- [LangGraph + assistant-ui](/docs/cloud/langgraph)

You can also check out our example repositories to see how to integrate Assistant Cloud with your frontend:

- [AI SDK (standalone)](https://github.com/assistant-ui/assistant-ui/tree/main/examples/with-cloud-standalone)
- [AI SDK + assistant-ui](https://github.com/assistant-ui/assistant-ui/tree/main/examples/with-cloud)
- [LangGraph + assistant-ui](https://github.com/assistant-ui/assistant-ui/tree/main/examples/with-langgraph)
