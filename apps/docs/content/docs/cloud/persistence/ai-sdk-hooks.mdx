...
If you're using the [AI SDK](https://sdk.vercel.ai/) with your own UI components (not assistant-ui), the `assistant-cloud` package provides two hooks that add full thread persistence with minimal integration effort:
...
- If you want pre-built UI components, see [AI SDK](/docs/cloud/persistence/ai-sdk) for the full assistant-ui integration
